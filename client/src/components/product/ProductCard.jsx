...
function ProductCard({ photo, name, price, sale }) {
  return (
    <div className="md:w-[22rem] w-[16rem] aspect-[3/4] border-solid border-[.1rem] border-orangeColor rounded-[.5rem] overflow-hidden relative">
      ...
      <div>
        <h3 className="text-orangeColor text-[1.8rem] md:text-[2rem] text-center my-[.5rem] font-bold">{name}</h3>
        <div className="w-full flex gap-[1rem] md:gap-[2rem] justify-center my-[.5rem]  md:my-[1rem]">
          <span className="text-primaryColor font-bold text-[1.6rem] md:text-[1.8rem]">{sale.concat('đ')}</span>
